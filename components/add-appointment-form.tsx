...
export function AddAppointmentForm({ startups }: AddAppointmentFormProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    //   toast({ title: "Appointment added successfully" })
      ...
      router.refresh()
        ...
        console.log(error)
    //   toast({ title: "Error adding appointment", variant: "destructive" })
    } finally {
      setIsLoading(false)
    }
  }
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Follow-up Committee">Follow-up Committee</SelectItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Optional description of the appointment</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
